    ...
    <section aria-labelledby="safety-parameters-title">
      ...
      <form className="mt-8 space-y-6" noValidate onSubmit={(event) => void submit(event)}>
        <fieldset className="border border-slate-200 bg-white p-5 sm:p-6">
          <legend className="px-1 text-lg font-semibold text-slate-950">Skor Keselamatan</legend>
        ...
        <fieldset className="border border-slate-200 bg-white p-5 sm:p-6">
          <legend className="px-1 text-lg font-semibold text-slate-950">Stabilisasi Episode dan deteksi</legend>
        ...
        <fieldset className="border border-slate-200 bg-white p-5 sm:p-6">
          <legend className="px-1 text-lg font-semibold text-slate-950">Jadwal Reset Skor</legend>
