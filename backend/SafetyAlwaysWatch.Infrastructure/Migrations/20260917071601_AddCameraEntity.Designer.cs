...
namespace SafetyAlwaysWatch.Infrastructure.Migrations
{
    ...
    [Migration("20260917071601_AddCameraEntity")]
    partial class AddCameraEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SafetyAlwaysWatch.Domain.Entities.Camera", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SafetyAlwaysWatch.Domain.Entities.HazardousZone", b =>
                {
                    b.HasOne("SafetyAlwaysWatch.Domain.Entities.Camera", null)
                        .WithMany()
